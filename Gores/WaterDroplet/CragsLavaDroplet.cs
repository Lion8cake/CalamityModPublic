...
{
    public class CragsLavaDroplet : ModGore
    {
        ...
        public override bool Update(Gore gore)
        {
            ...
            if (gore.frame <= 4)
            {
                ...
                if (gore.frameCounter >= frameDuration)
                {
                    ...
                    if (gore.frame == 5)
                    {
                        int droplet = Gore.NewGore(new EntitySource_Misc(nameof(CragsLavaDroplet)), gore.position, gore.velocity, gore.type);
			...
			num24 = (2.5f / 4) * num27; //R
			num25 = (1.1f / 4) * num27; //G
			num26 = (0.1f / 4) * num27; //B
